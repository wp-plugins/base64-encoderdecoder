...
1. Install `base64-encoderdecoder.0.6.1.zip` to `/wp-content/plugins/` directory right from Wordpress Plugin Directory or unzip `base64-encoderdecoder.0.6.1.zip` and upload the entire `base64-encoderdecoder` folder to `/wp-content/plugins/` directory.
